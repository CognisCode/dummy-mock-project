...
// impl Player {
//     pub fn new(pos_x: f32, pos_y: f32, size: f32, player_type: PlayerType, id: i16, value: i32, score: RefCell<i32>, color: Color) -> Player {
...
//                 *chaser.score.borrow_mut() += reward;
...
//     pub fn chase_highest_rewards(&mut self, highrewards: &Vec<&Player>, lowrewards: &Vec<&Player>) -> TargetGoal {
...
//         self.direction = Vec2::new(direction.x , direction.y);
